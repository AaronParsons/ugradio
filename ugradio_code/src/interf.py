...
DELTA_ALT_ANT_W = -0.4  # (true - encoder) offset, updated 1/10/26 (M.V.)
DELTA_AZ_ANT_W  =  4.5  # (true - encoder) offset, updated 1/10/26 (M.V.)
DELTA_ALT_ANT_E =  0.5  # (true - encoder) offset, updated 1/13/26 (M.V.)
DELTA_AZ_ANT_E  =  0.5  # (true - encoder) offset, updated 1/13/26 (M.V.)
