...
panic of writing up at the last minute. If you write descriptions and captions as you go,
you save yourself the existential horror of the blank page.
...
\noindent
In order to achieve these goals, you must develop many new technical skills. Resources
on Astrobaki, in these instructions, and on the World Wide Web are all at your disposal.
...
without raising an exception, but that doesn't necessarily mean it did what you intended. In software as in science,
...
The goal of this investigation is to help you produce a section of your report
...
phenomenon and your understanding of it. Ideally, this section should be framed
as a targetted question that you pose and then answer.
...
an analog filter?}" Feel free to create (and answer) your own unique question.
...
should be good to go. Feel free to connect up the keyboard, monitor, and power on the lab
bench, and then plug in an SDR module 
(e.g. the Nooelec NESDR SMART) into your RPi's USB port and pull up a terminal on
your RPi.

A good start is to hook up a cheap antenna to the NESDR input,
run {\tt gqrx} at the terminal, press the ``Play" button, and then fiddle with the
settings (e.g., Automatic Gain Control, WFM Stereo). With audio output hooked up, 
...
Good science is founded on inspection, verification, and documentation. In that spirit,
