...
\section{SCHEDULE}
\begin{enumerate}
\item {\it The First Week. For class JD=2458527:} % XXX change this each year
Finish \S\ref{radioastro} and \S \ref{analysis}, and understand \S
  \ref{jultime}. Be prepared for `show and tell'.

\item {\it The Second Week. For class JD=2458534:} % XXX change this each year
...
2458527. % XXX change this each year
...
about 58527. % XXX change this each year
