PRO sunposred, jd, ra, dec, longmed, oblt, RADIAN = radian
;+
;
;THIS PROGRAM WORKS EXACTLY LIKE SUNPOS, EXCEPT THAT IT USES THE
;REDUCED JULIAN DATE (JD-2400000.) FOR INPUT.
;
;
; NAME:
;       SUNPOSRED
...
;
; CALLING SEQUENCE:
;       SUNPOSRED, jd, ra, dec, [elong, obliquity, /RADIAN ]
; INPUTS:
...
;       Modifed from SUNPOS by ES (5/2001)
;-
 On_error,2
;                       Check arguments.
...
; t = (jd - 2415020.0d)/36525.0d0
 t = (jd - 15020.0d)/36525.0d0 ; THIS LINE CHANGED BY ES
