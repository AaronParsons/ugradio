...
;    plot,talt,tdelta,ps=2
                                ...
                                ;MAKE FAKE DATA
        faketalt=findgen(80)
        f=flegendre(faketalt,5)
        faketdeltaf=a[0]*f[*,0]+a[1]*f[*,1]+a[2]*f[*,2]+a[3]*f[*,3]+a[4]*f[*,4]
        faketdeltar=faketdeltaf
;        faketdeltaf=a[0]+a[1]*(cos(faketalt*!dtor))
;        faketdeltar=-a[0]+a[1]*(cos(faketalt*!dtor)) ; HEY HEY HEY I CHANGED
