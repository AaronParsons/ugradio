pro homer, tries = tries, woohoo = woohoo, doh = doh
;+
; NAME:
;     HOMER
; PURPOSE:
...
if not keyword_set(tries) then tries = 5

; Try the generic homing call.
spawn, 'echo point tense alt_e=75 az_e=180 az_w=180 alt_w=75 | '+sendpc, msg
;print, "msg", msg
;stop
...
doh = 0
print, 'nr of homing attempts = ', ntries
